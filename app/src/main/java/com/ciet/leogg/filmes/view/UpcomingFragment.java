...
public class UpcomingFragment extends Fragment implements MoviesContract.ListView {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tabInteraction = TabPresenter.getInstance().setUpcomingView(this);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.upcoming_list);
    ...
    private static class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                mItemListener.onMovieClick(filme);
