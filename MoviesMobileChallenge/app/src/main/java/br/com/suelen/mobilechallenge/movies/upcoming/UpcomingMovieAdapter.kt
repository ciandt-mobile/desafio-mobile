...
class UpcomingMovieAdapter :  ListAdapter<Movie, UpcomingMovieAdapter.MovieViewHolder>(MovieDiffCallback()) {
    ...
    class MovieViewHolder(private val binding : MovieItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item : Movie) {
            binding.apply {
                ...
                item.release_date?.apply {
                    releaseDateField = DateTimeUtil.reformatStringDate(this)
                }
